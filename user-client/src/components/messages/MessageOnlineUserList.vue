<template>
  <div :style="`overflow-y: auto; height: ` + height + `px;background: transparent;border-right: 1px solid rgba(255, 255, 255, 0.12);`">
...
export default class MessageOnlineUserList extends Vue {
  ...
  setHeight() {
    ...
    this.height = window.innerHeight - appBarHeight;
  }
